---
source: https://mas.owasp.org/MASTG/knowledge/ios/MASVS-PLATFORM/MASTG-KNOW-0074/
scopes:
  - test
  - ios
  - mobile
...
# MASTG-KNOW-0074: Enforced Updating

## 概要

* 本ドキュメントは OWASP MASTG Knowledge「Enforced Updating」（iOS / プラットフォーム連携）を、DO / DO NOT 監査向けに蒸留したものである。
...
* 正本: <https://mas.owasp.org/MASTG/knowledge/ios/MASVS-PLATFORM/MASTG-KNOW-0074/>
...
* SKStoreProductViewController: (StoreKit): presents the App Store product page in-app for a smoother user experience.
* 公式記事内のコード例言語: txt
```
...
- 変更レビューで MASTG-KNOW-0074 を参照リンクとして残す
```

## 参考リンク

* 本 Knowledge: <https://mas.owasp.org/MASTG/knowledge/ios/MASVS-PLATFORM/MASTG-KNOW-0074/>
