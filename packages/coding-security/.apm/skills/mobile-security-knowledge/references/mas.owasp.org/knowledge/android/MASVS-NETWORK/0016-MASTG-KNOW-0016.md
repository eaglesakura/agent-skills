---
source: https://mas.owasp.org/MASTG/knowledge/android/MASVS-NETWORK/MASTG-KNOW-0016/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Knowledge「TBD」（Android / ネットワーク）を、DO / DO NOT 監査向けに蒸留したものである。
* 公式ステータスは placeholder である。内容が未充足の可能性があるため、実装必須根拠には使わない。

* 正本: <https://mas.owasp.org/MASTG/knowledge/android/MASVS-NETWORK/MASTG-KNOW-0016/>
...
- 変更レビューで MASTG-KNOW-0016 を参照リンクとして残す
```

## 参考リンク

* 本 Knowledge: <https://mas.owasp.org/MASTG/knowledge/android/MASVS-NETWORK/MASTG-KNOW-0016/>
