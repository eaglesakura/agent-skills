---
source: https://mas.owasp.org/MASTG/knowledge/android/MASVS-STORAGE/MASTG-KNOW-0039/
scopes:
  - test
  - android
  - mobile
...
# MASTG-KNOW-0039: Firebase Real-time Databases

## 概要

* 本ドキュメントは OWASP MASTG Knowledge「Firebase Real-time Databases」（Android / データ保存）を、DO / DO NOT 監査向けに蒸留したものである。
...
* 正本: <https://mas.owasp.org/MASTG/knowledge/android/MASVS-STORAGE/MASTG-KNOW-0039/>
...
- 変更レビューで MASTG-KNOW-0039 を参照リンクとして残す
```

## 参考リンク

* 本 Knowledge: <https://mas.owasp.org/MASTG/knowledge/android/MASVS-STORAGE/MASTG-KNOW-0039/>
