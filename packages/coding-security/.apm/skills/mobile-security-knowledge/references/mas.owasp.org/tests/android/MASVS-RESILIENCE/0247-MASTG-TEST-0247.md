---
source: https://mas.owasp.org/MASTG/tests/android/MASVS-RESILIENCE/MASTG-TEST-0247/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「References to APIs for Detecting Secure Screen Lock」（Android / 耐タンパ・耐解析）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
...
* メタ: type: static, code; profiles: L2; weakness: MASWE-0017; knowledge: MASTG-KNOW-0001
* 正本: <https://mas.owasp.org/MASTG/tests/android/MASVS-RESILIENCE/MASTG-TEST-0247/>
...
# DO
- MASTG-TEST-0247 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/android/MASVS-RESILIENCE/MASTG-TEST-0247/>
