---
source: https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0375/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「Missing Validation of Data Returned from Implicit Intents」（Android / コード品質）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
...
* メタ: type: dynamic, hooks, manual; profiles: L1, L2; weakness: MASWE-0050; knowledge: MASTG-KNOW-0025, MASTG-KNOW-0138
* 正本: <https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0375/>
* 関連制御群: `MASVS-CODE`
* 関連 Knowledge 索引: `docs/security/mas.owasp.org/knowledge/0000-index.md`

## Missing Validation of Data Returned from Implicit Intentsのテスト実施

テスト目的・手順・合否基準を固定し、実装レビューとセキュリティテストで再利用する。

### Missing Validation of Data Returned from Implicit Intentsのテスト実施の補足
...
### Missing Validation of Data Returned from Implicit Intentsのテスト実施の実装例

```text
公式テストの実施ステップ（要約）である。
* Use MASTG-TECH-0005 to install the app.
* Use MASTG-TECH-0043 to hook the relevant API calls.
* Exercise the app extensively to trigger flows that request data from another app through an implicit intent.
合否（Evaluation）の要点:
...
* 観測期待: The output should contain runtime traces of intent result handling flows. The output should include, when available:
```
...
# DO
- MASTG-TEST-0375 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0375/>
