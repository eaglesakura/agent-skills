---
source: https://mas.owasp.org/MASTG/tests/ios/MASVS-PLATFORM/MASTG-TEST-0370/
scopes:
  - test
  - ios
  - mobile
...
合否（Evaluation）の要点:
* The test case fails if the URL handler uses parameter values directly without performing adequate validation. This includes missing type conversion (e.g. not converting a numeric parameter to Int), missing bounds or r...
* 観測期待: The output should contain the disassembly of the URL handler, showing whether it performs type conversion or bounds checking on URL parameters.
```
...
# DO
- MASTG-TEST-0370 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/ios/MASVS-PLATFORM/MASTG-TEST-0370/>
