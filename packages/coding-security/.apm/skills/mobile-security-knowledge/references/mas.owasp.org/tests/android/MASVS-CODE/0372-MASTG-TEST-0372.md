---
source: https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0372/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「Implicit Intents Used for Internal App Communication」（Android / コード品質）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
...
* 正本: <https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0372/>
* 関連制御群: `MASVS-CODE`
* 関連 Knowledge 索引: `docs/security/mas.owasp.org/knowledge/0000-index.md`

## Implicit Intents Used for Internal App Communicationのテスト実施

テスト目的・手順・合否基準を固定し、実装レビューとセキュリティテストで再利用する。

### Implicit Intents Used for Internal App Communicationのテスト実施の補足
...
### Implicit Intents Used for Internal App Communicationのテスト実施の実装例
...
* 観測期待: The output should contain Intent creation and dispatch sites. For each reported dispatch, the output should include, when available:
```
...
# DO
- MASTG-TEST-0372 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0372/>
