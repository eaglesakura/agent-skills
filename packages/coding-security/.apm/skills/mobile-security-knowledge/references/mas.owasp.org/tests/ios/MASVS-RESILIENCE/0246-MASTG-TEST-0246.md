---
source: https://mas.owasp.org/MASTG/tests/ios/MASVS-RESILIENCE/MASTG-TEST-0246/
scopes:
  - test
  - ios
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「Runtime Use of Secure Screen Lock Detection APIs」（iOS / 耐タンパ・耐解析）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
* 公式ステータスは current である。検証手順の正本は公式記事とする。
* 要旨: This test is the dynamic counterpart to MASTG-TEST-0248.
* メタ: type: dynamic, hooks; profiles: L2; weakness: MASWE-0017; knowledge: MASTG-KNOW-0056
* 正本: <https://mas.owasp.org/MASTG/tests/ios/MASVS-RESILIENCE/MASTG-TEST-0246/>
...
# DO
- MASTG-TEST-0246 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/ios/MASVS-RESILIENCE/MASTG-TEST-0246/>
