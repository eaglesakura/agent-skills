---
source: https://mas.owasp.org/MASTG/tests/android/MASVS-CRYPTO/MASTG-TEST-0309/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「References to Reused Initialization Vectors in Symmetric Encryption」（Android / 暗号）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
...
* メタ: type: static, code; profiles: L2; weakness: MASWE-0007
* 正本: <https://mas.owasp.org/MASTG/tests/android/MASVS-CRYPTO/MASTG-TEST-0309/>
* 関連制御群: `MASVS-CRYPTO`
* 関連 Knowledge 索引: `docs/security/mas.owasp.org/knowledge/0000-index.md`

## References to Reused Initialization Vectors in Symmetric Encryptionのテスト実施

テスト目的・手順・合否基準を固定し、実装レビューとセキュリティテストで再利用する。

### References to Reused Initialization Vectors in Symmetric Encryptionのテスト実施の補足
...
### References to Reused Initialization Vectors in Symmetric Encryptionのテスト実施の実装例
...
# DO
- MASTG-TEST-0309 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/android/MASVS-CRYPTO/MASTG-TEST-0309/>
