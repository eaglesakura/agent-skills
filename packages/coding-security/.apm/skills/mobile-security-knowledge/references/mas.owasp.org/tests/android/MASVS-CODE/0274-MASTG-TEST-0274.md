---
source: https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0274/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「Dependencies with Known Vulnerabilities in the App's SBOM」（Android / コード品質）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
* 公式ステータスは current である。検証手順の正本は公式記事とする。
* 要旨: In this test case we are identifying dependencies with known vulnerabilities by relying on a Software Bill of Material (SBOM).
* メタ: type: static, developer; profiles: L1, L2; weakness: MASWE-0044
* 正本: <https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0274/>
* 関連制御群: `MASVS-CODE`
...
# DO
- MASTG-TEST-0274 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/android/MASVS-CODE/MASTG-TEST-0274/>
