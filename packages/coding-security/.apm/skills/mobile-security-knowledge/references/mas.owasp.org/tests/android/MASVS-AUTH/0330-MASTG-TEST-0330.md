---
source: https://mas.owasp.org/MASTG/tests/android/MASVS-AUTH/MASTG-TEST-0330/
scopes:
  - test
  - android
  - mobile
...
* 本ドキュメントは OWASP MASTG Test「References to APIs for Keys used in Biometric Authentication with Extended Validity Duration」（Android / 認証・認可）を、テストナレッジ／DO NOT 監査向けに蒸留したものである。
...
* 正本: <https://mas.owasp.org/MASTG/tests/android/MASVS-AUTH/MASTG-TEST-0330/>
* 関連制御群: `MASVS-AUTH`
* 関連 Knowledge 索引: `docs/security/mas.owasp.org/knowledge/0000-index.md`

## References to APIs for Keys used in Biometric Authentication with Extended Validity Durationのテスト実施

テスト目的・手順・合否基準を固定し、実装レビューとセキュリティテストで再利用する。

### References to APIs for Keys used in Biometric Authentication with Extended Validity Durationのテスト実施の補足
...
### References to APIs for Keys used in Biometric Authentication with Extended Validity Durationのテスト実施の実装例
...
* A non-zero authentication validity duration is not inherently a vulnerability. Short durations in the range of seconds may be acceptable for certain use cases where multiple related operations need to be performed in ...
...
# DO
- MASTG-TEST-0330 の合否を Evaluation に照らして記録する
- 失敗時は関連 MASWE / 修正方針 / 再テスト条件を起票する
```

## 参考リンク

* 本 Test: <https://mas.owasp.org/MASTG/tests/android/MASVS-AUTH/MASTG-TEST-0330/>
